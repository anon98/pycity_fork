...
def main():
    ...
    # Perform the city district scheduling using the centralized reference benchmark algorithm:
    opt = CentralOptimization(city_district=district, mode=mode)
    results = opt.solve()
    print("Day-ahead centralized reference benchmark optimization completed.")
